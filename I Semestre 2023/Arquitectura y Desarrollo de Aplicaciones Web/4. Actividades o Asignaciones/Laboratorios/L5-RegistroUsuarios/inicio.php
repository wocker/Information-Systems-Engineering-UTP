...
if (isset($_GET['lang'])) {
    ...
    // Redirigir a la carpeta correspondiente según el idioma seleccionado
    if ($selectedLang === 'en') {
...
// Obtener el idioma almacenado en la sesión o en la cookie, si existe
$selectedLang = isset($_SESSION['selectedLang']) ? $_SESSION['selectedLang'] : '';
